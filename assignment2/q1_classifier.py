...
class SoftmaxModel(Model):
    ...
    def add_placeholders(self):
        ...
        """
        ### YOUR CODE HERE
        self.input = tf.placeholder(tf.float32, [None, Config.n_features],
                               "input")
        self.labels = tf.placeholder(tf.int32, [None, Config.n_classes],
                               "labels")
        ### END YOUR CODE
    ...
    def create_feed_dict(self, inputs_batch, labels_batch=None):
        ...
        """
        ### YOUR CODE HERE
        feed_dict = {self.input: inputs_batch, self.labels: labels_batch}
    ...
    def add_prediction_op(self):
        ...
        W = tf.Variable(tf.zeros([Config.n_features, Config.n_classes]),
                        name="weights")
        b = tf.Variable(tf.zeros([Config.n_classes]), name="bias")

        logits = tf.add(tf.matmul(self.input, W), b)
        pred = softmax(logits)
        ### END YOUR CODE
        return pred
